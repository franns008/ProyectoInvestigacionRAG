...
class Pipeline:
    ...
    def pipe(self, user_message: str, model_id: str, messages: List[dict], body: dict) -> Union[str, Generator, Iterator]:
        print(f"[DEBUG-PIPE] Iniciando ejecución de RAG Pipeline.")
        print(f"[DEBUG-PIPE] Mensaje del usuario: '{user_message}'")
        print(f"[DEBUG-PIPE] ID Modelo entrante: {model_id} | Usando configurado: {self.valves.llm_model}")
        ...
        if prompt_generado:
            ...
            print("[DEBUG-PROMPT] Advertencia: No se pudo capturar el output del prompt_builder en el pipeline run.")
        ...
        print(f"[DEBUG-PIPE] Fin ejecución RAG Pipeline.")
